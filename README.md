...
Aplicativo desktop para sorteio de números desenvolvido para a UNIVASF.
...
Desenvolvido para atender a uma demanda acadêmica da turma de História da UNIVASF, com o objetivo de organizar e automatizar o sorteio de participantes para debates em sala, garantindo imparcialidade e agilidade no processo.

## Demo

| Tela Inicial | Configuração |
|:------------:|:------------:|
| <img src=".github/prev-inicio.png" width="350"> | <img src=".github/prev-config.png" width="350"> |

| Sorteio em Andamento | Resultado Final |
|:--------------------:|:---------------:|
| <img src=".github/prev-sort.png" width="350"> | <img src=".github/prev-final.png" width="350"> |
